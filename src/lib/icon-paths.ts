// Vendored from the Mingloo Consulting design system bundle (Lucide, ISC licence).
// 24x24 viewBox, 2px stroke, round caps and joins. Do not restyle per-icon.
...
export const ICON_PATHS: Record<string, string> = {
  ...
  // Added to the vendored set: the toolkit's View button asks for "eye", which
  // the design system bundle does not ship, so it silently fell back to
  // "sparkles". Taken from the same Lucide release as the rest of this file.
